...
private:
    ...
    /**
     * Consumes an expression and validates it is a relational expression via recursive descent.
    ...
    /**
     * Consumes a deque of tokens and validates it is an expression via recursive descent.
     * @param tokens Deque of tokens passed by reference
     */
    void validateExpr(std::deque<SPToken> &tokens);

    /**
     * Consumes a deque of tokens and validates it is term in an expression via recursive descent.
     * @param tokens Deque of tokens passed by reference
     */
    ...
    /**
     * Takes in a deque of tokens starting with a '(' and finds the index of the matching closing parenthesis.
     * @param tokens Deque of tokens passed by reference
     ...
     */
    std::tuple<std::deque<SPToken>, std::deque<SPToken>, std::string> splitExpression(std::deque<SPToken> &expression,
                                                                                      TokenType type);
