...
private:
    ...
    buildStatementListSubgraph(std::unordered_map<Statement, std::shared_ptr<CFGNode>> &map,
     ...
     */
    static std::pair<std::shared_ptr<CFGNode>, std::shared_ptr<CFGNode>>
    buildStatementSubgraph(std::unordered_map<Statement, std::shared_ptr<CFGNode>> &map,
     ...
     */
    static std::pair<std::shared_ptr<CFGNode>, std::shared_ptr<CFGNode>>
    buildIfSubgraph(std::unordered_map<Statement, std::shared_ptr<CFGNode>> &map,
     ...
     */
    static std::pair<std::shared_ptr<CFGNode>, std::shared_ptr<CFGNode>>
    buildWhileSubgraph(std::unordered_map<Statement, std::shared_ptr<CFGNode>> &map,
...
public:
     ...
     */
    static std::unordered_map<ProcedureName, std::unordered_map<Statement, std::shared_ptr<CFGNode>>>
