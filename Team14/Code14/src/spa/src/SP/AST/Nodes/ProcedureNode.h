...
/**
 * Visitor interface linked to ProcedureNode, used to implement the Acyclic Visitor pattern.
 */
...
public:
     ...
     */
    explicit ProcedureNode(ProcedureName procedureName, std::shared_ptr<StatementListNode> statementList);
