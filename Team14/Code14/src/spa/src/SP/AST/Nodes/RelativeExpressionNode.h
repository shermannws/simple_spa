...
public:
     ...
     */
    virtual void
    visitRelativeExpressionNode(RelativeExpressionNode *node,
...
private:
     ...
     */
    inline static const std::unordered_map<std::string, ComparisonOperatorType>
            stringToOperatorTypeMap = {
                    {AppConstants::STRING_GREATER_THAN,
                     ComparisonOperatorType::GreaterThan},
                    {AppConstants::STRING_GREATER_EQUAL,
                     ComparisonOperatorType::GreaterThanEqual},
                    {AppConstants::STRING_LESS_THAN,
                     ComparisonOperatorType::LessThan},
                    {AppConstants::STRING_LESS_EQUAL,
                     ComparisonOperatorType::LessThanEqual},
                    {AppConstants::STRING_DOUBLE_EQUAL,
                     ComparisonOperatorType::Equal},
                    {AppConstants::STRING_NOT_EQUAL,
...
public:
     ...
     * @param rightExpression The RHS expression (arithmetic, variable,
     * constant)
     */
    explicit RelativeExpressionNode(
            ComparisonOperatorType comparisonOperatorType,
            std::shared_ptr<ExpressionNode> leftExpression,
            std::shared_ptr<ExpressionNode> rightExpression);
     ...
     * the corresponding ComparisonOperatorType value.
    ...
    translateComparisonOperatorType(const std::string &operatorTypeString);
