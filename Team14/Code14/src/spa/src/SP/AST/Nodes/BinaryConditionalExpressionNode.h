...
public:
     ...
     */
    virtual void visitBinaryConditionalExpressionNode(
...
private:
    ...
    /**
     * Map of binary conditional operator type string to
     * BinaryConditionalExpressionType.
     */
    inline static const std::unordered_map<std::string,
                                           BinaryConditionalExpressionType>
            stringToExpressionTypeMap = {{AppConstants::STRING_AND,
                                          BinaryConditionalExpressionType::And},
                                         {AppConstants::STRING_OR,
                                          BinaryConditionalExpressionType::Or}};

public:
    /**
     * Creates and initializes a BinaryConditionalExpressionNode.
     * @param binaryConditionalExpressionType The type of binary conditional
     * operator
     ...
     */
    explicit BinaryConditionalExpressionNode(
            BinaryConditionalExpressionType binaryConditionalExpressionType,
            std::shared_ptr<ConditionalExpressionNode>
                    leftConditionalExpression,
            std::shared_ptr<ConditionalExpressionNode>
    ...
    /**
     * Converts the given string representing a binary conditional operator to
     * the corresponding BinaryConditionalExpressionType value.
     * @param typeString The string representing a binary conditional operator
     * @return The BinaryConditionalExpressionType value corresponding to the
     * string
     */
    static BinaryConditionalExpressionType
    translateBinaryConditionalExpressionTypeString(
