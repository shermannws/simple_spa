...
public:
    /**
     * Accepts the DesignExtractorVisitor and calls the visit method for this
     * ASTNode.
     * @param visitor A design extractor visitor which implements the
     * DesignExtractorVisitor interface
