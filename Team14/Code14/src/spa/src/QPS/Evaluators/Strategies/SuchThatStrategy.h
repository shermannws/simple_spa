...
public:
     ...
     */
    virtual std::shared_ptr<Result> evaluateSynSyn(Ref &leftRef,
                                                   Ref &rightRef) const = 0;
     ...
     * @return The result of the SuchThatClause evaluation as a Result object
     */
    virtual std::shared_ptr<Result> evaluateSynAny(Ref &leftRef,
                                                   Ref &rightRef) const = 0;

    /**
     * @brief Evaluates SuchThatClause that has a synonym in the second
     * parameters
     * @param leftRef The first parameter of the SuchThatClause to evaluate
     * @param rightRef The second parameter of the SuchThatClause to evaluate
     * @return The result of the SuchThatClause evaluation as a Result object
     */
    virtual std::shared_ptr<Result> evaluateAnySyn(Ref &leftRef,
                                                   Ref &rightRef) const = 0;
     ...
     * @return The result of the SuchThatClause evaluation as a Result object
     */
    virtual std::shared_ptr<Result> evaluateBoolean(Ref &leftRef,
                                                    Ref &rightRef) const = 0;
    ...
    evaluateClause(std::shared_ptr<Clause> clause) const override;
};
