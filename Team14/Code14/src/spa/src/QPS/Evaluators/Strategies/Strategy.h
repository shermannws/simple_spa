...
/**
 * Strategy interface for each type of clause e.g. UsesSuchThatStrategy, AssignPatternStrategy, etc
 */
class Strategy {
public:
    /**
     ...
     * @return The shared pointer to result of the clause evaluation
     */
