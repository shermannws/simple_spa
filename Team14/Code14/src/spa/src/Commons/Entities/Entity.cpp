...
Entity::Entity(const std::shared_ptr<EntityValue> entityValue,
...
std::size_t std::hash<std::shared_ptr<Entity>>::operator()(
        const std::shared_ptr<Entity> entityPtr) const {
