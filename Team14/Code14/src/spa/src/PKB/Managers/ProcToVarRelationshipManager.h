...
/**
 * @class ProcToVarRelationshipManager is responsible for storing and retrieving
 * the relationships between procedure and variables. This class is a template
 * class that is inherited by the Relationship Managers
...
public:
     ...
     */
    void storeRelationship(std::shared_ptr<Procedure> procedure,
                           std::shared_ptr<Variable> variable);

    /**
     * Returns a vector of Procedure, Variable pair where the procedure is
    ...
    /**
     * Returns a boolean value indicating if the given procedure is related to
     * the given variable
     * @param procedure The procedure that is related to the variable
    ...
    /**
     * Calculates and populate the ProcToVarRelationship relationshipStore with
     * the given CallsRelationshipManager
     * @param callManager The CallsRelationshipManager
     */
    void calculateProcVarRelationshipForCallers(
            std::shared_ptr<CallsRelationshipManager> callManager);

    /**
     * Returns an EntityStore of variables which is related to the given
     * procedure
     * @param left The procedure on the left that is related to the variables
     * @returns An EntityStore of variables that is on the right of the given
     * procedure
     */
    std::shared_ptr<EntityStore<Variable>>
    getRhsVarAsVariables(std::shared_ptr<Procedure> left) const;
};
