...
private:
    /**
     * @brief The ConstantStore that stores all the constants in the SIMPLE
     * source program
     */
    std::shared_ptr<ConstantStore> constantStore;

    /**
     * @brief The ProcedureStore that stores all the procedures in the SIMPLE
     * source program
     */
    std::shared_ptr<ProcedureStore> procedureStore;

    /**
     * @brief The StatementStore that stores all the statements in the SIMPLE
     * source program
     */
    std::shared_ptr<StatementStore> statementStore;

    /**
     * @brief The VariableStore that stores all the variables in the SIMPLE
     * source program
     */
...
protected:
    ...
    /**
     * @brief Returns all the entities of type E in the EntityStore of type E
     * that matches the matcher function
     * @tparam E The type of the Entity
     * @param entityStore The EntityStore to retrieve the entities from
     ...
     */
    template<typename E>
    std::vector<Entity> getEntities(std::shared_ptr<EntityStore<E>>,
...
public:
    ...
    /**
     * @brief Returns the Statement object from the StatementStore that is equal
     * to the Statement object passed in
     * @param s The Statement object to be compared against
     * @return The Statement object from the StatementStore that is equal to the
     * Statement object passed in
     */
    std::shared_ptr<Entity> getStatement(std::shared_ptr<Statement> s) const;

    /**
     * @brief Returns the Variable object from the VariableStore that is equal
     * to the Variable object passed in
     * @param v The Variable object to be compared against
     * @return The Variable object from the VariableStore that is equal to the
     * Variable object passed in
     */
    std::shared_ptr<Entity> getVariable(std::shared_ptr<Variable> v) const;

    /**
     * @brief Returns the Constant object from the ConstantStore that is equal
     * to the Constant object passed in
     * @param c The Constant object to be compared against
     * @return The Constant object from the ConstantStore that is equal to the
     * Constant object passed in
     */
    std::shared_ptr<Entity> getConstant(std::shared_ptr<Constant> c) const;

    /**
     * @brief Returns the Procedure object from the ProcedureStore that is equal
     * to the Procedure object passed in
     * @param p The Procedure object to be compared against
     * @return The Procedure object from the ProcedureStore that is equal to the
     * Procedure object passed in
     */
