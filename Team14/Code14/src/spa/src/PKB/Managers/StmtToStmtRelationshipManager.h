...
/**
 * @class StmtToStmtRelationshipManager is responsible for storing and
 * retrieving the relationships between statements and statements. This class is
 * a template class that is inherited by the Relationship Managers
 */
template<typename S>
...
public:
     ...
     */
    void storeRelationship(std::shared_ptr<Statement> statement1,
     ...
     */
    virtual std::vector<Entity>
    getRelationshipTypeWildcard(StatementType type, bool requireDirect) const;
     ...
     */
    virtual std::vector<Entity>
    getRelationshipWildcardType(StatementType type, bool requireDirect) const;
     ...
     */
    virtual bool isRelationship(Statement &statement1, Statement &statement2,
                                bool requireDirect) const;
    ...
    /**
     * Returns true if there exists a relationship where the given statement is
     * the former statement, false otherwise
     * @param statement The statement to be checked
     * @return True if there exists a relationship where the given statement is
     * the former statement, false otherwise
     */
    ...
    /**
     * Returns true if there exists a relationship where the given statement is
     * the latter statement, false otherwise
     * @param statement The statement to be checked
     * @return True if there exists a relationship where the given statement is
     * the latter statement, false otherwise
     */
