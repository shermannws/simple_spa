...
/**
 * @class StmtToVarRelationshipManager is responsible for storing and retrieving
 * the relationships between statements and variables. This class is a template
...
public:
     ...
     */
    void storeRelationship(std::shared_ptr<Statement> statement,
                           std::shared_ptr<Variable> variable);

    /**
     * Returns a vector of Statement, Variable pair where the statement is
     * related to the variable. Retrieves the relationship where the statement
     * is of the given type
     * @param type The type of the statement
     * @return A vector of Statement, Variable pair stored in a vector
     */
    std::vector<std::vector<Entity>>
    getRelationshipStmtPair(StatementType type) const;

    /**
     * Returns a vector of statements of StatementType type which is related to
     * the given variable
     ...
     */
    std::vector<Entity> getRelationshipTypeIdent(StatementType type,
                                                 Variable &var) const;
    ...
    /**
     * Returns a boolean value indicating if the given statement is related to
     * the given variable
