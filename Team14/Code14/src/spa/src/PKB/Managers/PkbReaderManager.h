...
public:
    ...
    getFollowsPair(StatementType formerType, StatementType latterType) const;
     ...
     * @return A vector of statements
     */
    std::vector<Entity> getFollowsStarTypeStmt(StatementType type,
                                               Statement &statement) const;
     ...
     * @return A vector of statements
     */
    std::vector<Entity> getFollowsStarStmtType(Statement &statement,
                                               StatementType type) const;
     ...
     */
    std::vector<std::vector<Entity>>
    getModifiesStmtPair(StatementType type) const;
     ...
     */
    std::vector<std::vector<Entity>>
    getAssignStmtsVarPairByRhs(Expression &rhs, bool hasWildCard) const;
     ...
     */
    std::vector<Entity> getAssignStmtsByLhsRhs(Variable &lhs, Expression &rhs,
                                               bool hasRhsWildCard) const;
     ...
     */
    std::vector<std::vector<Entity>>
    getParentPair(StatementType formerType, StatementType latterType) const;
     ...
     */
    std::vector<std::vector<Entity>>
    getParentStarPair(StatementType formerType, StatementType latterType) const;
     ...
     * @return A vector of statements
     */
    std::vector<Entity> getParentStarTypeStmt(StatementType type,
                                              Statement &statement) const;
     ...
     * @return A vector of statements
     */
    std::vector<Entity> getParentStarStmtType(Statement &statement,
                                              StatementType type) const;
     ...
     * @return A vector of procedures
     */
    std::vector<Entity> getCallees() const;
     ...
     * @return A vector of procedures
     */
    std::vector<Entity> getCalleesStar() const;

    /**
     * Returns a vector of procedures which calls any other procedure directly
     * @return A vector of procedures
     */
    std::vector<Entity> getCallers() const;
     ...
     * @return A vector of procedures
     */
    std::vector<Entity> getCallersStar() const;
     ...
     */
    std::vector<std::vector<Entity>> getCallsPair() const;
     ...
     * @return A vector of Procedure, Procedure pair stored in a vector
     */
    std::vector<std::vector<Entity>> getCallsStarPair() const;
     ...
     * @return A vector of procedures
     */
    std::vector<Entity> getCallers(Procedure &callee) const;
     ...
     * @return A vector of procedures
     */
    std::vector<Entity> getCallersStar(Procedure &callee) const;
     ...
     * @return A vector of procedures
     */
    std::vector<Entity> getCallees(Procedure &caller) const;
     ...
     */
    std::vector<std::vector<Entity>>
    getNextPair(StatementType formerType, StatementType latterType) const;
     ...
     */
    std::vector<std::vector<Entity>>
    getNextStarPair(StatementType formerType, StatementType latterType) const;
     ...
     * @return A vector of statements
     */
    std::vector<Entity> getNextStarTypeStmt(StatementType type,
                                            Statement &statement) const;
