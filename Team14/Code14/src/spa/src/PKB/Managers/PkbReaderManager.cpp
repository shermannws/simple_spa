...
std::vector<Entity> PkbReaderManager::getAllWhile() const {
    ...
    // TODO: Change to whilePatternManager & delete getAllWhile() from
    // EntityManager return this->whilePatternManager->getAllStmts();
}
...
PkbReaderManager::getUsesStmtPair(StatementType type) const {
...
std::vector<Entity> PkbReaderManager::getUsesTypeIdent(StatementType type,
                                                       Variable &var) const {
...
std::vector<std::vector<Entity>>
PkbReaderManager::getFollowsPair(StatementType formerType,
                                 StatementType latterType) const {
    return this->followsRelationshipManager->getRelationshipPair(
            formerType, latterType, true);
}

std::vector<std::vector<Entity>>
PkbReaderManager::getFollowsStarPair(StatementType formerType,
                                     StatementType latterType) const {
    return this->followsRelationshipManager->getRelationshipPair(
            formerType, latterType, false);
}

std::vector<Entity>
PkbReaderManager::getFollowsTypeStmt(StatementType type,
                                     Statement &statement) const {
    return this->followsRelationshipManager->getRelationshipTypeStmt(
            type, statement, true);
}

std::vector<Entity>
PkbReaderManager::getFollowsStarTypeStmt(StatementType type,
                                         Statement &statement) const {
    return this->followsRelationshipManager->getRelationshipTypeStmt(
...
std::vector<Entity>
PkbReaderManager::getFollowsTypeWildcard(StatementType type) const {
    return this->followsRelationshipManager->getRelationshipTypeWildcard(type);
}

std::vector<Entity>
PkbReaderManager::getFollowsStarTypeWildcard(StatementType type) const {
    return this->followsRelationshipManager->getRelationshipTypeWildcard(type);
}

std::vector<Entity>
PkbReaderManager::getFollowsStmtType(Statement &statement,
                                     StatementType type) const {
    return this->followsRelationshipManager->getRelationshipStmtType(
            statement, type, true);
}

std::vector<Entity>
PkbReaderManager::getFollowsStarStmtType(Statement &statement,
                                         StatementType type) const {
    return this->followsRelationshipManager->getRelationshipStmtType(
...
std::vector<Entity>
PkbReaderManager::getFollowsWildcardType(StatementType type) const {
    return this->followsRelationshipManager->getRelationshipWildcardType(type);
}

std::vector<Entity>
PkbReaderManager::getFollowsStarWildcardType(StatementType type) const {
    return this->followsRelationshipManager->getRelationshipWildcardType(type);
}

bool PkbReaderManager::isFollows(Statement &statement1,
                                 Statement &statement2) const {
    return this->followsRelationshipManager->isRelationship(statement1,
                                                            statement2, true);
}

bool PkbReaderManager::isFollowsStar(Statement &statement1,
                                     Statement &statement2) const {
    return this->followsRelationshipManager->isRelationship(statement1,
                                                            statement2, false);
}
...
std::vector<std::vector<Entity>>
PkbReaderManager::getModifiesStmtPair(StatementType type) const {
...
std::vector<Entity>
PkbReaderManager::getModifiesTypeIdent(StatementType type,
                                       Variable &var) const {
    return this->modifiesRelationshipManager->getRelationshipTypeIdent(type,
                                                                       var);
}

std::vector<Entity>
PkbReaderManager::getModifiesProcIdent(Variable &var) const {
    return this->modifiesProcRelationshipManager->getRelationshipIdent(var);
}

std::vector<Entity>
PkbReaderManager::getModifiesStmt(StatementType type) const {
...
// pattern a (_, "x")
std::vector<Entity>
PkbReaderManager::getAssignStmtsByRhs(Expression &rhs,
...
// pattern a (v, _)
std::vector<std::vector<Entity>>
PkbReaderManager::getAllAssignStmtVarPair() const {
    return this->assignmentManager->getAllAssignStmtVarPair();
}

// pattern a (v, "x")
std::vector<std::vector<Entity>>
PkbReaderManager::getAssignStmtsVarPairByRhs(Expression &rhs,
                                             bool hasWildCard) const {
    return this->assignmentManager->getAssignStmtsVarPairByRhs(rhs,
                                                               hasWildCard);
}
...
// pattern a ("x", "x")
std::vector<Entity>
PkbReaderManager::getAssignStmtsByLhsRhs(Variable &lhs, Expression &rhs,
                                         bool hasRhsWildCard) const {
    return this->assignmentManager->getAssignStmtsByLhsRhs(lhs, rhs,
                                                           hasRhsWildCard);
}

std::vector<std::vector<Entity>>
PkbReaderManager::getParentPair(StatementType formerType,
                                StatementType latterType) const {
    return this->parentRelationshipManager->getRelationshipPair(
            formerType, latterType, true);
}

std::vector<std::vector<Entity>>
PkbReaderManager::getParentStarPair(StatementType formerType,
                                    StatementType latterType) const {
    return this->parentRelationshipManager->getRelationshipPair(
            formerType, latterType, false);
}
...
std::vector<Entity>
PkbReaderManager::getParentTypeStmt(StatementType type,
                                    Statement &statement) const {
    return this->parentRelationshipManager->getRelationshipTypeStmt(
            type, statement, true);
}

std::vector<Entity>
PkbReaderManager::getParentStarTypeStmt(StatementType type,
                                        Statement &statement) const {
    return this->parentRelationshipManager->getRelationshipTypeStmt(
            type, statement, false);
}
...
std::vector<Entity>
PkbReaderManager::getParentTypeWildcard(StatementType type) const {
    return this->parentRelationshipManager->getRelationshipTypeWildcard(type);
}

std::vector<Entity>
PkbReaderManager::getParentStarTypeWildcard(StatementType type) const {
    return this->parentRelationshipManager->getRelationshipTypeWildcard(type);
}

std::vector<Entity>
PkbReaderManager::getParentStmtType(Statement &statement,
                                    StatementType type) const {
    return this->parentRelationshipManager->getRelationshipStmtType(statement,
                                                                    type, true);
}

std::vector<Entity>
PkbReaderManager::getParentStarStmtType(Statement &statement,
                                        StatementType type) const {
    return this->parentRelationshipManager->getRelationshipStmtType(
            statement, type, false);
}

std::vector<Entity>
PkbReaderManager::getParentWildcardType(StatementType type) const {
    return this->parentRelationshipManager->getRelationshipWildcardType(type);
}

std::vector<Entity>
PkbReaderManager::getParentStarWildcardType(StatementType type) const {
    return this->parentRelationshipManager->getRelationshipWildcardType(type);
}

bool PkbReaderManager::isParent(Statement &statement1,
                                Statement &statement2) const {
    return this->parentRelationshipManager->isRelationship(statement1,
                                                           statement2, true);
}

bool PkbReaderManager::isParentStar(Statement &statement1,
                                    Statement &statement2) const {
    return this->parentRelationshipManager->isRelationship(statement1,
                                                           statement2, false);
}
...
bool PkbReaderManager::isCallsStar(Procedure &caller, Procedure &callee) const {
    return this->callsRelationshipManager->isRelationship(caller, callee,
                                                          false);
}
...
std::vector<std::vector<Entity>>
PkbReaderManager::getNextPair(StatementType formerType,
                              StatementType latterType) const {
    return this->nextRelationshipManager->getRelationshipPair(formerType,
                                                              latterType, true);
}

std::vector<std::vector<Entity>>
PkbReaderManager::getNextStarPair(StatementType formerType,
                                  StatementType latterType) const {
    return this->nextRelationshipManager->getRelationshipPair(
            formerType, latterType, false);
}

std::vector<Entity>
PkbReaderManager::getNextStarSameStmt(StatementType stmtType) const {
    return this->nextRelationshipManager->getNextStarSameStmt(stmtType);
}

std::vector<Entity>
PkbReaderManager::getNextTypeStmt(StatementType type,
                                  Statement &statement) const {
    return this->nextRelationshipManager->getRelationshipTypeStmt(
            type, statement, true);
}

std::vector<Entity>
PkbReaderManager::getNextStarTypeStmt(StatementType type,
                                      Statement &statement) const {
    return this->nextRelationshipManager->getRelationshipTypeStmt(
            type, statement, false);
}
...
std::vector<Entity>
PkbReaderManager::getNextTypeWildcard(StatementType type) const {
    return this->nextRelationshipManager->getRelationshipTypeWildcard(type,
                                                                      true);
}

std::vector<Entity>
PkbReaderManager::getNextStarTypeWildcard(StatementType type) const {
    return this->nextRelationshipManager->getRelationshipTypeWildcard(type,
                                                                      false);
}

std::vector<Entity>
PkbReaderManager::getNextStmtType(Statement &statement,
                                  StatementType type) const {
    return this->nextRelationshipManager->getRelationshipStmtType(statement,
                                                                  type, true);
}

std::vector<Entity>
PkbReaderManager::getNextStarStmtType(Statement &statement,
                                      StatementType type) const {
    return this->nextRelationshipManager->getRelationshipStmtType(statement,
                                                                  type, false);
}
...
std::vector<Entity>
PkbReaderManager::getNextWildcardType(StatementType type) const {
    return this->nextRelationshipManager->getRelationshipWildcardType(type,
                                                                      true);
}

std::vector<Entity>
PkbReaderManager::getNextStarWildcardType(StatementType type) const {
    return this->nextRelationshipManager->getRelationshipWildcardType(type,
                                                                      false);
}

bool PkbReaderManager::isNext(Statement &statement1,
                              Statement &statement2) const {
    return this->nextRelationshipManager->isRelationship(statement1, statement2,
                                                         true);
}

bool PkbReaderManager::isNextStar(Statement &statement1,
                                  Statement &statement2) const {
    return this->nextRelationshipManager->isRelationship(statement1, statement2,
                                                         false);
}
...
std::vector<std::vector<Entity>>
PkbReaderManager::getAllWhileStmtVarPair() const {
