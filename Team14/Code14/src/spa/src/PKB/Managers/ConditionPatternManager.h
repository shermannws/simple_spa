...
/**
 * @class ConditionPatterManager is responsible for storing and retrieving the
 * statement patterns This class is a template class that is inherited by the
 * Pattern Managers
...
public:
    ...
    /**
     * Returns a vector of Statement objects the store with pattern using the
     * given variable.
    ...
    /**
     * Returns a vector of vectors containing all the Statement and Variable
     * pairs in the store
