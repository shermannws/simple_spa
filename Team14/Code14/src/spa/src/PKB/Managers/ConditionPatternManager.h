...
public:
     ...
     */
    std::unordered_set<Entity> getAllStmts() const;
     ...
     */
    std::unordered_set<Entity> getStmtsByVar(Variable &var) const;
     ...
     */
    std::unordered_set<std::vector<Entity>> getAllStmtVarPair() const;
};
