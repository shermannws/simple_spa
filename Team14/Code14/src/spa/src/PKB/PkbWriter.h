...
public:
     ...
     */
    virtual void addAssignPattern(std::shared_ptr<Statement> s, std::shared_ptr<Variable> lhs,
                                  std::shared_ptr<Expression> rhs) = 0;

    /*!
     * Adds new Follows Relationship into the PKB
     */
    virtual void addFollowsRelationship(std::shared_ptr<Statement> s1, std::shared_ptr<Statement> s2,
                                        bool isDirect) = 0;
     ...
     */
    virtual void addProcedureToStatementsMap(std::shared_ptr<Procedure> p,
     ...
     */
    virtual void addIfPattern(std::shared_ptr<Statement> s,
                              std::shared_ptr<std::vector<std::shared_ptr<Variable>>> v) = 0;

    /*!
     * Adds new While Pattern into the PKB
     */
    virtual void addWhilePattern(std::shared_ptr<Statement> s,
                                 std::shared_ptr<std::vector<std::shared_ptr<Variable>>> v) = 0;
};