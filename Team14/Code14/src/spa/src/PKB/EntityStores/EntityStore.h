 ...
 * @details This class is a template class that takes in a type T that is a
 * subclass of Entity. This class is a super class of all the entity stores.
...
public:
    ...
    /**
     * @brief Returns the entity from the EntityStore that is equal to the
     * entity passed in
     * @param entity The entity to be compared against
     * @return The entity from the EntityStore that is equal to the entity
     * passed in
     */
