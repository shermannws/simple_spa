...
Pkb::Pkb() {
    ...
    this->pkbReaderManager =
            std::make_shared<PkbReaderManager>(PkbReaderManager(
                    this->assignmentManager, this->entitiesManager,
                    this->followsRelationshipManager,
                    ...
                    this->callsRelationshipManager,
                    this->modifiesProcRelationshipManager,
                    this->usesProcRelationshipManager, this->ifPatternManager,
                    this->whilePatternManager, this->nextRelationshipManager));
    this->pkbWriterManager = std::make_shared<PkbWriterManager>(
            PkbWriterManager(this->assignmentManager, this->entitiesManager,
                             this->followsRelationshipManager,
                             this->usesRelationshipManager,
                             this->modifiesRelationshipManager,
                             this->parentRelationshipManager,
                             ...
                             this->modifiesProcRelationshipManager,
                             this->usesProcRelationshipManager,
                             this->ifPatternManager, this->whilePatternManager,
                             this->nextRelationshipManager, this->cfgManager));
};
