...
PkbConcreteReader::getUsesStmtPair(StatementType type) const {
...
std::vector<Entity> PkbConcreteReader::getUsesTypeIdent(StatementType type,
                                                        Variable &var) const {
...
std::vector<std::vector<Entity>>
PkbConcreteReader::getFollowsPair(StatementType formerType,
                                  StatementType latterType) const {
    return this->readerManager->getFollowsPair(formerType, latterType);
}

std::vector<std::vector<Entity>>
PkbConcreteReader::getFollowsStarPair(StatementType formerType,
                                      StatementType latterType) const {
    return this->readerManager->getFollowsStarPair(formerType, latterType);
}

std::vector<Entity>
PkbConcreteReader::getFollowsTypeStmt(StatementType type,
                                      Statement &statement) const {
    return this->readerManager->getFollowsTypeStmt(type, statement);
}

std::vector<Entity>
PkbConcreteReader::getFollowsStarTypeStmt(StatementType type,
                                          Statement &statement) const {
    return this->readerManager->getFollowsStarTypeStmt(type, statement);
}

std::vector<Entity>
PkbConcreteReader::getFollowsTypeWildcard(StatementType type) const {
    return this->readerManager->getFollowsTypeWildcard(type);
}

std::vector<Entity>
PkbConcreteReader::getFollowsStarTypeWildcard(StatementType type) const {
    return this->readerManager->getFollowsStarTypeWildcard(type);
}

std::vector<Entity>
PkbConcreteReader::getFollowsStmtType(Statement &statement,
                                      StatementType type) const {
    return this->readerManager->getFollowsStmtType(statement, type);
}

std::vector<Entity>
PkbConcreteReader::getFollowsStarStmtType(Statement &statement,
                                          StatementType type) const {
    return this->readerManager->getFollowsStarStmtType(statement, type);
}

std::vector<Entity>
PkbConcreteReader::getFollowsWildcardType(StatementType type) const {
    return this->readerManager->getFollowsWildcardType(type);
}

std::vector<Entity>
PkbConcreteReader::getFollowsStarWildcardType(StatementType type) const {
    return this->readerManager->getFollowsStarWildcardType(type);
}

bool PkbConcreteReader::isFollows(Statement &statement1,
                                  Statement &statement2) const {
    return this->readerManager->isFollows(statement1, statement2);
}

bool PkbConcreteReader::isFollowsStar(Statement &statement1,
                                      Statement &statement2) const {
...
std::vector<std::vector<Entity>>
PkbConcreteReader::getModifiesStmtPair(StatementType type) const {
    return this->readerManager->getModifiesStmtPair(type);
}

std::vector<std::vector<Entity>>
PkbConcreteReader::getModifiesProcPair() const {
    return this->readerManager->getModifiesProcPair();
}

std::vector<Entity>
PkbConcreteReader::getModifiesTypeIdent(StatementType type,
                                        Variable &var) const {
    return this->readerManager->getModifiesTypeIdent(type, var);
}

std::vector<Entity>
PkbConcreteReader::getModifiesProcIdent(Variable &var) const {
    return this->readerManager->getModifiesProcIdent(var);
}

std::vector<Entity>
PkbConcreteReader::getModifiesStmt(StatementType type) const {
...
bool PkbConcreteReader::isStmtModifiesVar(Statement &stmt,
                                          Variable &var) const {
    return this->readerManager->isStmtModifiesVar(stmt, var);
}

bool PkbConcreteReader::isProcModifiesVar(Procedure &proc,
                                          Variable &var) const {
...
// pattern a (_, "x")
std::vector<Entity>
PkbConcreteReader::getAssignStmtsByRhs(Expression &rhs,
...
// pattern a (v, _)
std::vector<std::vector<Entity>>
PkbConcreteReader::getAllAssignStmtVarPair() const {
    return this->readerManager->getAllAssignStmtVarPair();
}

// pattern a (v, "x")
std::vector<std::vector<Entity>>
PkbConcreteReader::getAssignStmtsVarPairByRhs(Expression &rhs,
...
// pattern a ("x", _)
std::vector<Entity>
PkbConcreteReader::getAssignStmtsByLhs(Variable &lhs) const {
    return this->readerManager->getAssignStmtsByLhs(lhs);
}

// pattern a ("x", "x")
std::vector<Entity>
PkbConcreteReader::getAssignStmtsByLhsRhs(Variable &lhs, Expression &rhs,
                                          bool hasRhsWildCard) const {
    return this->readerManager->getAssignStmtsByLhsRhs(lhs, rhs,
                                                       hasRhsWildCard);
}

std::vector<std::vector<Entity>>
PkbConcreteReader::getParentPair(StatementType formerType,
                                 StatementType latterType) const {
    return this->readerManager->getParentPair(formerType, latterType);
}

std::vector<std::vector<Entity>>
PkbConcreteReader::getParentStarPair(StatementType formerType,
                                     StatementType latterType) const {
    return this->readerManager->getParentStarPair(formerType, latterType);
}

std::vector<Entity>
PkbConcreteReader::getParentTypeStmt(StatementType type,
                                     Statement &statement) const {
    return this->readerManager->getParentTypeStmt(type, statement);
}

std::vector<Entity>
PkbConcreteReader::getParentStarTypeStmt(StatementType type,
                                         Statement &statement) const {
    return this->readerManager->getParentStarTypeStmt(type, statement);
}

std::vector<Entity>
PkbConcreteReader::getParentTypeWildcard(StatementType type) const {
    return this->readerManager->getParentTypeWildcard(type);
}

std::vector<Entity>
PkbConcreteReader::getParentStarTypeWildcard(StatementType type) const {
    return this->readerManager->getParentStarTypeWildcard(type);
}

std::vector<Entity>
PkbConcreteReader::getParentStmtType(Statement &statement,
                                     StatementType type) const {
    return this->readerManager->getParentStmtType(statement, type);
}

std::vector<Entity>
PkbConcreteReader::getParentStarStmtType(Statement &statement,
                                         StatementType type) const {
    return this->readerManager->getParentStarStmtType(statement, type);
}

std::vector<Entity>
PkbConcreteReader::getParentWildcardType(StatementType type) const {
    return this->readerManager->getParentWildcardType(type);
}

std::vector<Entity>
PkbConcreteReader::getParentStarWildcardType(StatementType type) const {
    return this->readerManager->getParentStarWildcardType(type);
}

bool PkbConcreteReader::isParent(Statement &statement1,
                                 Statement &statement2) const {
    return this->readerManager->isParent(statement1, statement2);
}

bool PkbConcreteReader::isParentStar(Statement &statement1,
                                     Statement &statement2) const {
...
bool PkbConcreteReader::isCallsStar(Procedure &caller,
...
std::vector<std::vector<Entity>>
PkbConcreteReader::getNextPair(StatementType formerType,
                               StatementType latterType) const {
    return this->readerManager->getNextPair(formerType, latterType);
}

std::vector<std::vector<Entity>>
PkbConcreteReader::getNextStarPair(StatementType formerType,
                                   StatementType latterType) const {
    return this->readerManager->getNextStarPair(formerType, latterType);
}

std::vector<Entity>
PkbConcreteReader::getNextStarSameStmt(StatementType stmtType) const {
    return this->readerManager->getNextStarSameStmt(stmtType);
}

std::vector<Entity>
PkbConcreteReader::getNextTypeStmt(StatementType type,
                                   Statement &statement) const {
    return this->readerManager->getNextTypeStmt(type, statement);
}

std::vector<Entity>
PkbConcreteReader::getNextStarTypeStmt(StatementType type,
                                       Statement &statement) const {
    return this->readerManager->getNextStarTypeStmt(type, statement);
}

std::vector<Entity>
PkbConcreteReader::getNextTypeWildcard(StatementType type) const {
    return this->readerManager->getNextTypeWildcard(type);
}

std::vector<Entity>
PkbConcreteReader::getNextStarTypeWildcard(StatementType type) const {
    return this->readerManager->getNextStarTypeWildcard(type);
}

std::vector<Entity>
PkbConcreteReader::getNextStmtType(Statement &statement,
                                   StatementType type) const {
    return this->readerManager->getNextStmtType(statement, type);
}

std::vector<Entity>
PkbConcreteReader::getNextStarStmtType(Statement &statement,
                                       StatementType type) const {
    return this->readerManager->getNextStarStmtType(statement, type);
}

std::vector<Entity>
PkbConcreteReader::getNextWildcardType(StatementType type) const {
    return this->readerManager->getNextWildcardType(type);
}

std::vector<Entity>
PkbConcreteReader::getNextStarWildcardType(StatementType type) const {
    return this->readerManager->getNextStarWildcardType(type);
}

bool PkbConcreteReader::isNext(Statement &statement1,
                               Statement &statement2) const {
    return this->readerManager->isNext(statement1, statement2);
}

bool PkbConcreteReader::isNextStar(Statement &statement1,
                                   Statement &statement2) const {
...
std::vector<std::vector<Entity>>
PkbConcreteReader::getAllIfStmtVarPair() const {
...
std::vector<std::vector<Entity>>
PkbConcreteReader::getAllWhileStmtVarPair() const {
