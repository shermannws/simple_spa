...
template <typename K1, typename K2, typename V1, typename V2, typename H1, typename H2>
typename std::unordered_map<std::shared_ptr<K1>, typename std::shared_ptr<V1>>::iterator DoubleMapStore<K1, K2, V1, V2, H1, H2>::getLeftToRightBeginIterator() {
    return this->leftToRightStore.begin();
}

template <typename K1, typename K2, typename V1, typename V2, typename H1, typename H2>
typename std::unordered_map<std::shared_ptr<K1>, typename std::shared_ptr<V1>>::iterator DoubleMapStore<K1, K2, V1, V2, H1, H2>::getLeftToRightEndIterator() {
    return this->leftToRightStore.end();
}

template <typename K1, typename K2, typename V1, typename V2, typename H1, typename H2>
typename std::unordered_map<std::shared_ptr<K2>, typename std::shared_ptr<V2>>::iterator DoubleMapStore<K1, K2, V1, V2, H1, H2>::getRightToLeftBeginIterator() {
    return this->rightToLeftStore.begin();
}

template <typename K1, typename K2, typename V1, typename V2, typename H1, typename H2>
typename std::unordered_map<std::shared_ptr<K2>, typename std::shared_ptr<V2>>::iterator DoubleMapStore<K1, K2, V1, V2, H1, H2>::getRightToLeftEndIterator() {
