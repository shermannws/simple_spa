...
void ASTPrinterVisitor::visitIfNode(const std::shared_ptr<IfNode> &node, std::vector<std::shared_ptr<ASTNode>> parents,
                                    std::shared_ptr<ASTNode> proc) const {
    std::cout << ":if\n";
}
...
void ASTPrinterVisitor::visitBinaryConditionalExpressionNode(
        const std::shared_ptr<BinaryConditionalExpressionNode> &node, std::vector<std::shared_ptr<ASTNode>> parents,
                                                             std::shared_ptr<ASTNode> proc) const {
