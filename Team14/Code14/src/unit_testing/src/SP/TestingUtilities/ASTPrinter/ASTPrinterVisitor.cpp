...
void ASTPrinterVisitor::visitBinaryConditionalExpressionNode(
        BinaryConditionalExpressionNode *node,
        std::vector<std::shared_ptr<ASTNode>> parents,
        std::shared_ptr<ASTNode> proc) const {
    std::cout << (node->getBinaryConditionalExpressionType() ==
...
void ASTPrinterVisitor::visitUnaryConditionalExpressionNode(
...
void ASTPrinterVisitor::visitRelativeExpressionNode(
        RelativeExpressionNode *node,
        std::vector<std::shared_ptr<ASTNode>> parents,
        std::shared_ptr<ASTNode> proc) const {
    ...
    assert(stringMap.find(node->getComparisonOperatorType()) !=
           stringMap.end());
