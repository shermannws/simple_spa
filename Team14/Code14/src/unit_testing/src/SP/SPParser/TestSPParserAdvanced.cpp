...
TEST_CASE_METHOD(UnitTestFixture, "Valid program with single statements") {
    ...
    SECTION("Single if") {
        std::vector<SPToken> tokens = {
                ...
                SPToken(TokenType::OpenRoundParenthesis, "("), SPToken(TokenType::Name, "s"),
                SPToken(TokenType::RelationalOperator, "=="), SPToken(TokenType::Name, "x"),
                SPToken(TokenType::CloseRoundParenthesis, ")"),

                SPToken(TokenType::Name, "then"),
                // then statement list
                SPToken(TokenType::OpenCurlyParenthesis, "{"), SPToken(TokenType::Name, "x"),
                SPToken(TokenType::Equals, "="), SPToken(TokenType::Name, "v"), SPToken(TokenType::Semicolon, ";"),
                SPToken(TokenType::CloseCurlyParenthesis, "}"),

                SPToken(TokenType::Name, "else"),
                // else statement list
                SPToken(TokenType::OpenCurlyParenthesis, "{"), SPToken(TokenType::Name, "x"),
                SPToken(TokenType::Equals, "="), SPToken(TokenType::Integer, "1"), SPToken(TokenType::Semicolon, ";"),
                SPToken(TokenType::CloseCurlyParenthesis, "}"),
...
TEST_CASE_METHOD(UnitTestFixture, "Valid program with multiple statements") {
    ...
    std::vector<SPToken> tokens = {
            ...
            SPToken(TokenType::OpenCurlyParenthesis, "{"),
            // read statement
            SPToken(TokenType::Name, "read"), SPToken(TokenType::Name, "var1"), SPToken(TokenType::Semicolon, ";"),
            // print statement
            SPToken(TokenType::Name, "print"), SPToken(TokenType::Name, "var1"), SPToken(TokenType::Semicolon, ";"),
            // assign statement
            ...
            SPToken(TokenType::Semicolon, ";"),
            // if with assign
            SPToken(TokenType::Name, "if"), SPToken(TokenType::OpenRoundParenthesis, "("),
            SPToken(TokenType::Name, "s"), SPToken(TokenType::RelationalOperator, "<="), SPToken(TokenType::Name, "x"),
            SPToken(TokenType::CloseRoundParenthesis, ")"), SPToken(TokenType::Name, "then"),
            SPToken(TokenType::OpenCurlyParenthesis, "{"), SPToken(TokenType::Name, "x"),
            SPToken(TokenType::Equals, "="), SPToken(TokenType::Name, "v"), SPToken(TokenType::Semicolon, ";"),
            SPToken(TokenType::CloseCurlyParenthesis, "}"), SPToken(TokenType::Name, "else"),
            SPToken(TokenType::OpenCurlyParenthesis, "{"), SPToken(TokenType::Name, "x"),
            SPToken(TokenType::Equals, "="), SPToken(TokenType::Integer, "1"), SPToken(TokenType::Semicolon, ";"),
            SPToken(TokenType::CloseCurlyParenthesis, "}"),
            // while with read and print
            SPToken(TokenType::Name, "while"), SPToken(TokenType::OpenRoundParenthesis, "("),
            SPToken(TokenType::Name, "k"), SPToken(TokenType::RelationalOperator, ">"), SPToken(TokenType::Name, "1"),
            SPToken(TokenType::CloseRoundParenthesis, ")"), SPToken(TokenType::OpenCurlyParenthesis, "{"),
            SPToken(TokenType::Name, "print"), SPToken(TokenType::Name, "var1"), SPToken(TokenType::Semicolon, ";"),
            SPToken(TokenType::Name, "read"), SPToken(TokenType::Name, "var2"), SPToken(TokenType::Semicolon, ";"),
            SPToken(TokenType::CloseCurlyParenthesis, "}"),
...
TEST_CASE_METHOD(UnitTestFixture, "Valid program to test conditional expressions") {
    ...
    SECTION("Simple unary cond_expr") {
        std::vector<SPToken> tokens = {
                ...
                // statement list
                SPToken(TokenType::OpenCurlyParenthesis, "{"), SPToken(TokenType::Name, "a"),
                SPToken(TokenType::Equals, "="), SPToken(TokenType::Name, "r"), SPToken(TokenType::Semicolon, ";"),
                SPToken(TokenType::CloseCurlyParenthesis, "}"),
    ...
    SECTION("Simple binary cond_expr") {
        std::vector<SPToken> tokens = {
                ...
                SPToken(TokenType::Name, "a"), SPToken(TokenType::RelationalOperator, ">="),
                SPToken(TokenType::Name, "b"), SPToken(TokenType::CloseRoundParenthesis, ")"),
