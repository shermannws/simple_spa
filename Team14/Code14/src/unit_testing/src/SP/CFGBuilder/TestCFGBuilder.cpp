 ...
 * @return
 */
bool isSameStatements(const std::vector<std::shared_ptr<CFGNode>>& parents, std::vector<StatementNumber> correctParentStmtNums) {
    if (parents.size() != correctParentStmtNums.size()) {
        return false;
    }
