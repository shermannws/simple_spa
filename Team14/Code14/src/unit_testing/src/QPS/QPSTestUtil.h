...
public:
     ...
     */
    static std::shared_ptr<SuchThatClause>
    createSuchThatClause(ClauseType type, RefType t1, RootType r1,
     ...
     * @return
     */
    static std::shared_ptr<PatternClause>
    createPatternClause(ClauseType type, Synonym syn, RootType r1,
