...
TEST_CASE("Test Uses Procedure-Variable Relationship Retrieval") {
    ...
    usesProcRelationshipManager.storeRelationship(
    ...
    REQUIRE(usesProcRelationshipManager.getRelationshipIdent(variableX)
                    .size() == 2);
    ...
    REQUIRE(usesProcRelationshipManager.getRelationshipVar(procedure1).size() ==
            1);
    v = usesProcRelationshipManager.getRelationshipVar(procedure1);
    REQUIRE(find(v.begin(), v.end(), variableX) != v.end());
    REQUIRE(usesProcRelationshipManager.getRelationshipVar(procedure4).size() ==
            3);
    ...
    REQUIRE(usesProcRelationshipManager.isRelationship(procedure1, variableX) ==
            true);
    REQUIRE(usesProcRelationshipManager.isRelationship(procedure1, variableY) ==
            false);
    REQUIRE(usesProcRelationshipManager.isRelationship(procedure1, variableZ) ==
            false);
    REQUIRE(usesProcRelationshipManager.isRelationship(procedure2, variableX) ==
            false);
    REQUIRE(usesProcRelationshipManager.isRelationship(procedure2, variableY) ==
            true);
    REQUIRE(usesProcRelationshipManager.isRelationship(procedure2, variableZ) ==
            false);
    REQUIRE(usesProcRelationshipManager.isRelationship(procedure3, variableX) ==
            false);
    REQUIRE(usesProcRelationshipManager.isRelationship(procedure3, variableY) ==
            false);
    REQUIRE(usesProcRelationshipManager.isRelationship(procedure3, variableZ) ==
            true);
    REQUIRE(usesProcRelationshipManager.isRelationship(procedure4, variableX) ==
            true);
    REQUIRE(usesProcRelationshipManager.isRelationship(procedure4, variableY) ==
            true);
    REQUIRE(usesProcRelationshipManager.isRelationship(procedure4, variableZ) ==
            true);
...
TEST_CASE("Test Uses Procedure-Variable Transitive Relationship Calculations") {
    ...
    SECTION("Test permutation 1") {
        ...
        REQUIRE(usesProcRelationshipManager.isRelationship(procedure1,
                                                           variableX) == false);
        REQUIRE(usesProcRelationshipManager.isRelationship(procedure2,
                                                           variableX) == false);
        REQUIRE(usesProcRelationshipManager.isRelationship(procedure3,
                                                           variableX) == true);
    ...
    SECTION("Test permutation 2") {
        ...
        REQUIRE(usesProcRelationshipManager.isRelationship(procedure3,
                                                           variableZ) == true);
        REQUIRE(usesProcRelationshipManager.isRelationship(procedure4,
                                                           variableA) == true);
        REQUIRE(usesProcRelationshipManager.isRelationship(procedure5,
                                                           variableB) == true);
