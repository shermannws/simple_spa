...
TEST_CASE("Test Uses Relationship Retrieval") {
    ...
    REQUIRE(usesRelationshipManager
                    .getRelationshipStmtPair(StatementType::Print)
                    .size() == 1);
    REQUIRE(usesRelationshipManager
                    .getRelationshipStmtPair(StatementType::Assign)
                    .size() == 5);
    REQUIRE(usesRelationshipManager.getRelationshipStmtPair(StatementType::Stmt)
                    .size() == 6);

    REQUIRE(usesRelationshipManager
                    .getRelationshipTypeIdent(StatementType::Print,
                                              *variableTest)
                    .size() == 1);
    REQUIRE(usesRelationshipManager
    ...
    REQUIRE(usesRelationshipManager
                    ...
                    .size() == 2);
    REQUIRE(usesRelationshipManager
                    .getRelationshipTypeIdent(StatementType::Assign, *variableA)
                    .size() == 1);

    REQUIRE(usesRelationshipManager.getRelationshipStmt(StatementType::Print)
                    .size() == 1);
    REQUIRE(usesRelationshipManager.getRelationshipStmt(StatementType::Assign)
                    .size() == 2);

    REQUIRE(usesRelationshipManager.getRelationshipVar(*statement1).size() ==
            2);
    REQUIRE(usesRelationshipManager.getRelationshipVar(*statement2).size() ==
            3);
    REQUIRE(usesRelationshipManager.getRelationshipVar(*statement3).size() ==
            1);

    REQUIRE(usesRelationshipManager.isRelationship(*statement1, *variableY) ==
            true);
    REQUIRE(usesRelationshipManager.isRelationship(*statement1, *variableA) ==
            false);
