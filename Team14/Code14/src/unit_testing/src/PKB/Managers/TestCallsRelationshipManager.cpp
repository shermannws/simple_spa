...
TEST_CASE("Test Calls Relationship Retrieval") {
    ...
    REQUIRE(callsRelationshipManager.getCallsPair(true).size() == 2);
    REQUIRE(callsRelationshipManager.getCallsPair(false).size() == 3);
    ...
    REQUIRE(callsRelationshipManager.getCallsLatter(*procedure1, true).size() == 1);
    REQUIRE(callsRelationshipManager.getCallsLatter(*procedure1, false).size() == 2);
    REQUIRE(callsRelationshipManager.getCallsLatter().size() == 2);
